...
class GNG():
	...
	for i in range(0, len(a)):
		res += (a[0] - b[0])**2
        """Maybe squared/cubic/whatever root is required"""
	return res

    """TODO: check if this works in multidim"""
    def determine_2closest_vertices(self, curnode):
        """Where this curnode is actually the x,y,z... index of the data we want to analyze."""
	...
	for i in range(0, len(nodepos):
		move_delta = (self_eps.b * (nodepos[i] - winnerpos[i])
		newpos.append(winnerpos[i] + move_delta
	return newpos

"""."""
     Wth this was commented
